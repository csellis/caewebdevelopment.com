...
function IndexPage() {
  return (
    <Layout>
      <NextSeo
        title="Meet on V | Have amazing virtual events"
        description="We're creating Boutique Virtual Events."
      />
      {/* Hero */}
        ...
        <div className="container mx-auto px-8 lg:flex">
          <div className="text-center lg:text-left lg:w-1/2">
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
              Boutique <br /> virtual events
          </h1>
            <p className="text-xl lg:text-2xl mt-6 font-light">
              You can run an event on Zoom,
            <br className="hidden sm:block" /> but it won't fit your brand.
          </p>
      ...
      <section id="features" className="py-20 lg:pb-40 lg:pt-48">
        <div className="container mx-auto text-center">
          <h2 className="text-3xl lg:text-5xl font-semibold">Why brand matters.</h2>
          <div className="flex flex-col sm:flex-row sm:-mx-3 mt-12">
            <div className="flex-1 px-3">
              <Card className="mb-8">
                <p className="font-semibold text-xl">Trust.</p>
                <p className="mt-4">
                  You've been doing this a while. Your clients trust <strong>you</strong>. Branding
                your event matters.
              </p>
              </Card>
            </div>
            <div className="flex-1 px-3">
              <Card className="mb-8">
                ...
                <p className="mt-4">
                  You want a frictionless event. We integrate it with <strong>your</strong> existing
                site.
              </p>
              </Card>
            </div>
            <div className="flex-1 px-3">
              <Card className="mb-8">
                ...
                <p className="mt-4">
                  You've built a company with a certain aesthetic. We make the event{' '}
                  <strong>yours</strong>.
              </p>
              </Card>
            </div>
        ...
        <div className="relative max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            <svg className="mx-auto h-10" fill="none" viewBox="0 0 180 40">
              ...
              <path fill="#5850EC" fillRule="evenodd" d="M42.342 17.45l-7.596-4.385v20.371h8.88v1.974H.21v-1.974h3.947v-12.55l-3.678.92L0 19.89l20.81-5.202h3.08a9.421 9.421 0 00-.67 2.525l-.477 3.922 5.096-2.942v15.243h4.933v-20.37l-7.594 4.385a7.402 7.402 0 012.531-4.736h-4.064a7.39 7.39 0 016.557-2.933l-5.517-3.186a7.388 7.388 0 016.607.397 7.366 7.366 0 012.468 2.316 7.363 7.363 0 012.467-2.316 7.39 7.39 0 016.608-.397l-5.518 3.186a7.389 7.389 0 016.558 2.933h-4.066a7.399 7.399 0 012.533 4.735zm-18.45 6.119h-5.92v9.867h5.92v-9.867zm-10.854 1.973a1.974 1.974 0 11-3.947 0 1.974 1.974 0 013.947 0z" clipRule="evenodd" />
